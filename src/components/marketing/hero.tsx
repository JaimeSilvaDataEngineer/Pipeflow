...
function Hero() {
  return (
    <section className="mx-auto flex max-w-3xl animate-in flex-col items-center gap-6 px-4 pt-20 pb-16 text-center duration-700 fade-in slide-in-from-bottom-4 sm:px-6 sm:pt-28 sm:pb-24">
